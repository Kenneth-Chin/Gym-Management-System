 ...
 * @author User
 */
public class trainerTrainingSessionForm extends javax.swing.JFrame {
    ...
    public trainerTrainingSessionForm(Gym APUGym, Trainer tr_acc) {
        initComponents();
        ...
        for(int i = TrainingSessions.size() - 1; i >= 0; i--){
            ...
            if(ts.getTrainerID().equals(tr_acc.getUserID())){
                totalSessions++;
                ...
                if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    for(TrainingSession ts: APUGym.getTrainingSessions()){
                        if(ts.getTrainingSessionID() == table.getValueAt(row, 0)){
                            new trainerTrainingSessionDetailsForm(APUGym, tr_acc, ts).setVisible(true);
                            frame.dispose();
                            break;
                        }
                    }
    ...
    private void initComponents() {
        ...
        pastSessionsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Session Name", "Customers", "Date & Time", "Status"
            }
        ) {
        ...
        if (pastSessionsTable.getColumnModel().getColumnCount() > 0) {
            pastSessionsTable.getColumnModel().getColumn(0).setPreferredWidth(70);
            pastSessionsTable.getColumnModel().getColumn(0).setMaxWidth(70);
            pastSessionsTable.getColumnModel().getColumn(2).setPreferredWidth(160);
            pastSessionsTable.getColumnModel().getColumn(2).setMaxWidth(160);
            ...
            pastSessionsTable.getColumnModel().getColumn(4).setPreferredWidth(100);
            pastSessionsTable.getColumnModel().getColumn(4).setMaxWidth(100);
        }
        ...
        if (upcomingSessionsTable.getColumnModel().getColumnCount() > 0) {
            upcomingSessionsTable.getColumnModel().getColumn(0).setPreferredWidth(70);
            upcomingSessionsTable.getColumnModel().getColumn(0).setMaxWidth(70);
            upcomingSessionsTable.getColumnModel().getColumn(2).setPreferredWidth(160);
            upcomingSessionsTable.getColumnModel().getColumn(2).setMaxWidth(160);
            ...
            upcomingSessionsTable.getColumnModel().getColumn(4).setPreferredWidth(100);
            upcomingSessionsTable.getColumnModel().getColumn(4).setMaxWidth(100);
        }
