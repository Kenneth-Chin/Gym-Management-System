 ...
 * @author kelwi
 */
public class managerCancelTrainingSessionBookingForm extends javax.swing.JFrame {
    ...
    public managerCancelTrainingSessionBookingForm(Gym APUGym, Manager ma_acc) {
        initComponents();
    ...
    private void initComponents() {
                    ...
                    .addGroup(jLayeredPane4Layout.createSequentialGroup()
                        ...
                        .addGroup(jLayeredPane4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jLayeredPane4Layout.createSequentialGroup()
                                .addGroup(jLayeredPane4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jLabel12, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel17, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jLayeredPane4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(trainingSessionTrainer, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addComponent(trainingSessionTime, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel11.setText("Cancel Training Session Bookings");
        ...
        selectCustomers.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Booked Customers" }));
        ...
        cancelBut.setText("CANCEL BOOKING");
        ...
        jLabel1.setText("To be cancelled:");
        ...
        if(trainingSessionID.getText().equals("-----")){
            ...
            if(input==0){
                ...
                for(int i=0; i<customersTable.getRowCount(); i++){
                    ...
                    session.removeCustomerBooking(custID);
                    for(Payment pay: APUGym.getPayments()){
                        if(pay.getPaymentStatus().equals("Pending") && pay.getCustomerID().equals(custID) && pay.getPaymentItem().startsWith(session.getTrainingSessionID())){
    ...
    private void selectTrainingSessionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectTrainingSessionActionPerformed
        ...
        if(selectTrainingSession.getSelectedItem().equals("-")){
            ...
            selectCustomers.addItem("Booked Customers");
        } else{
            ...
            for(int i=0; i<bookedCustomerID.length; i++){
                selectCustomers.addItem(bookedCustomerID[i] + " - " + bookedCustomerName[i]);
            }
        }
    ...
    private void selectCustomersItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_selectCustomersItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            if(!(selectCustomers.getSelectedItem().equals("Booked Customers"))){
                Object selectedCust = selectCustomers.getSelectedItem();
                selectCustomers.setSelectedItem("Booked Customers");
